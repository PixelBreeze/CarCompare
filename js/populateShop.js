    ...
    $.ajax({
	    ...
	    var i=0;
            ...
            list.forEach(function(obj, index) {
                ...
                var divCompButton = '<div class="col-12"><div class="compare-btn"><a id="car.' + obj.id + '" class="btn btn-primary btn-sm" onclick="compareCar(event)" href="#"><i class="fa fa-exchange" aria-hidden="true"></i> Add to compare</a></div></div>';
